...
df$breadnobutt_mean <- apply(df[, paste("breadWithButt", suffixes, sep="_")], 1, function(x) {
    if (all(is.na(x))) {
      return(NA)
    } else {
      return(mean(x, na.rm = TRUE))
...
df$breadnobutt_mean <- apply(df[, paste("breadall", suffixes, sep="_")], 1, function(x) {
    if (all(is.na(x))) {
      return(NA)
    } else {
      return(mean(x, na.rm = TRUE))
...
df$breadnobutt_mean <- apply(df[, paste("pie", suffixes, sep="_")], 1, function(x) {
    if (all(is.na(x))) {
      return(NA)
    } else {
      return(mean(x, na.rm = TRUE))
...
df$breadnobutt_mean <- apply(df[, paste("dessert", suffixes, sep="_")], 1, function(x) {
    if (all(is.na(x))) {
      return(NA)
    } else {
      return(mean(x, na.rm = TRUE))
...
df$breadnobutt_mean <- apply(df[, paste("sweet", suffixes, sep="_")], 1, function(x) {
    if (all(is.na(x))) {
      return(NA)
    } else {
      return(mean(x, na.rm = TRUE))
...
df$breadnobutt_mean <- apply(df[, paste("savoury", suffixes, sep="_")], 1, function(x) {
    if (all(is.na(x))) {
      return(NA)
    } else {
      return(mean(x, na.rm = TRUE))
...
df$breadnobutt_mean <- apply(df[, paste("soup", suffixes, sep="_")], 1, function(x) {
    if (all(is.na(x))) {
      return(NA)
    } else {
      return(mean(x, na.rm = TRUE))
...
df$breadnobutt_mean <- apply(df[, paste("starchy", suffixes, sep="_")], 1, function(x) {
    if (all(is.na(x))) {
      return(NA)
    } else {
      return(mean(x, na.rm = TRUE))
...
```{r}
# remove all variables with _4.0, and the like
